...
namespace neuralnet {
	...
	*/
	...
	/**
	* Generates an unique unsigned int identifier which will act as a handler
	*/
	...
	*/
	...
	/**
	* Sets the input layer with the passed values
	*/
	...
	/**
	* Gets values from the output layer
	*/
	...
	/**
	* Retrieves values from a specified layer
	*/
	...
	*/
	...
	/**
	* Runs the backpropagation with a set of expected values
	*/
	...
	/**
	* Initializes functions for the export object
	*/
